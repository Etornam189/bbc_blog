    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <div class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                <div class="sidebar-brand-text mx-3">Post Admin</div>
            </div>
            ...
            <li class="nav-item">
                ...
                <div id="collapseCategories" class="collapse" aria-labelledby="headingCategories" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="dashboard.php?page=manage_categories">Manage Categories</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseCountries" class="collapse" aria-labelledby="headingCountries" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Manage Countries:</h6>
                        <a class="collapse-item" href="dashboard.php?page=manage_countries">Countries</a>
                    </div>
                </div>
            </li>
            ...
            <!-- MEDIA LIBRARY -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="../assets/" data-toggle="collapse" data-target="#collapseMedia"
                ...
                <div id="collapseMedia" class="collapse" aria-labelledby="headingMedia" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="dashboard.php?page=media_files">Media Files</a>
                    </div>
                </div>
            </li>
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                      <h6 class="collapse-header">Website</h6>
                        <a class="collapse-item" href="../index.php">Homepage</a>
                        <a class="collapse-item" href="dashboard.php?page=create_admin">Register</a>
                    </div>
                </div>
            </li>
            ...
            <div id="content">
               ...
               <!-- Begin Page Content -->
                    ...
                    if (isset($_GET['page'])) {
                        ...
                        elseif ($page == 'manage_countries') {
                            include 'countries.php';
                        }
                        elseif ($page == 'add_country') {
                            include 'add_country.php';
                        }
                        elseif ($page == 'media_files') {
                            include 'media.php';
                        }
                        ...
                        ?>
                            ...
                            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                ...
                                <a href="create_admin.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                                    Create Admin
                                </a>
                            </div>
